...
DEF SRAM_DISABLE EQU CART_SRAM_DISABLE
DEF SRAM_ENABLE  EQU CART_SRAM_ENABLE

DEF RTC_DH_HI       EQU RTC_DHB_HIGH
DEF RTC_DH_HALT     EQU RTC_DHB_HALT
DEF RTC_DH_OVERFLOW EQU RTC_DHB_CARRY

DEF VBLANK   EQU IEB_VBLANK
DEF LCD_STAT EQU IEB_STAT
DEF TIMER    EQU IEB_TIMER
DEF SERIAL   EQU IEB_SERIAL
DEF JOYPAD   EQU IEB_JOYPAD
...
DEF rJOYP_BUTTONS EQU JOYPB_GET_DPAD
DEF rJOYP_DPAD    EQU JOYPB_GET_BTN
...
DEF KEY1_PREPARE  EQU SPDB_PREPARE
DEF KEY1_DBLSPEED EQU SPDB_DBLSPEED
...
DEF rOBPI_AUTO_INCREMENT EQU OBPIB_AUTOINC

; constants/gfx_constants.asm

DEF TILE_WIDTH    EQU TILE_X
DEF LEN_1BPP_TILE EQU TILE_1BPP_B
DEF LEN_2BPP_TILE EQU TILE_B

DEF NUM_PAL_COLORS EQU PAL_COLORS
DEF PAL_COLOR_SIZE EQU COLOR_B
DEF PALETTE_SIZE   EQU PAL_B

DEF SCREEN_WIDTH     EQU SCRN_X_B
DEF SCREEN_HEIGHT    EQU SCRN_Y_B
DEF SCREEN_WIDTH_PX  EQU SCRN_X
DEF SCREEN_HEIGHT_PX EQU SCRN_Y

DEF BG_MAP_WIDTH  EQU SCRN_VX_B
DEF BG_MAP_HEIGHT EQU SCRN_VY_B
...
DEF SPRITEOAMSTRUCT_LENGTH     EQU OBJ_B
