...
CooltrainerMGroup:
	...
	db 35, KINGLER,    BUBBLEBEAM, STOMP, METAL_CLAW, PROTECT
	...
	db 39, KINGLER,    KINGS_ROCK,   SURF, STOMP, METAL_CLAW, BLIZZARD
	...
	db 32, KINGLER,    BUBBLEBEAM, STOMP, METAL_CLAW, PROTECT
...
BlackbeltGroup:
	...
	db 27, HITMONLEE,  DOUBLE_KICK, MEDITATE, ROLLING_KICK, FOCUS_ENERGY
	db -1 ; end
...
SECTION "Enemy Trainer Parties 2", ROMX ; gym leaders, rival and elite four

FalknerGroup:
	; FALKNER (1)
	db "FALKNER@", TRAINERTYPE_MOVES
	db 10, NATU,      PECK, LEER, NIGHT_SHADE, SWIFT
	db 11, HOOTHOOT,  TACKLE, GROWL, PECK, SWAGGER
	db 13, GLIGAR,    POISON_STING, HARDEN, MUD_SLAP, PROTECT
	db -1 ; end
