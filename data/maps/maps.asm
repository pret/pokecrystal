...
MapGroup_Saltbreeze:
	...
	map SaltbreezePokecenter1F, TILESET_POKECENTER, INDOOR, LANDMARK_SALTBREEZE_TOWN, MUSIC_POKEMON_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map WarrensHouse1F, TILESET_Z_HOUSE, INDOOR, LANDMARK_SALTBREEZE_TOWN, MUSIC_ANVILLE_TOWN, FALSE, PALETTE_AUTO, FISHGROUP_POND
	map WarrensHouse2F, TILESET_Z_HOUSE, INDOOR, LANDMARK_SALTBREEZE_TOWN, MUSIC_ANVILLE_TOWN, FALSE, PALETTE_AUTO, FISHGROUP_POND	
