...
MapGroup_Saltbreeze:
	...
	map MyHouse1F, TILESET_Z_HOUSE, INDOOR, LANDMARK_SALTBREEZE_TOWN, MUSIC_ANVILLE_TOWN, FALSE, PALETTE_DAY, FISHGROUP_POND
	...
	map SaltbreezePokemonCenter, TILESET_POKEMON_CENTER, INDOOR, LANDMARK_SALTBREEZE_TOWN, MUSIC_POKEMON_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map WarrensHouse1F, TILESET_Z_HOUSE, INDOOR, LANDMARK_SALTBREEZE_TOWN, MUSIC_ANVILLE_TOWN, FALSE, PALETTE_DAY, FISHGROUP_POND
	map WarrensHouse2F, TILESET_Z_HOUSE, INDOOR, LANDMARK_SALTBREEZE_TOWN, MUSIC_ANVILLE_TOWN, FALSE, PALETTE_DAY, FISHGROUP_POND	
	...
	map SunglowHarbor, TILESET_NEOST_OUTDOORS_1, ROUTE, LANDMARK_SUNGLOW_HARBOR, MUSIC_LAKE_OF_RAGE, FALSE, PALETTE_AUTO, FISHGROUP_POND
	...
	map SunglowCave1F, TILESET_NEOST_CAVE_1, CAVE, LANDMARK_SUNGLOW_CAVE, MUSIC_SHOAL_CAVE, FALSE, PALETTE_NITE | IN_DARKNESS, FISHGROUP_POND
