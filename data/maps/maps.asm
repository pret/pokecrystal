...
MapGroup_Saltbreeze:
	table_width MAP_LENGTH, MapGroup_Saltbreeze
;	map SaltbreezeTown, TILESET_NEOST_OUTDOORS_1, TOWN, LANDMARK_SALTBREEZE_TOWN, MUSIC_ANVILLE_TOWN, FALSE, PALETTE_AUTO, FISHGROUP_POND
;	map MyHouse1F, TILESET_Z_HOUSE, INDOOR, LANDMARK_SALTBREEZE_TOWN, MUSIC_ANVILLE_TOWN, FALSE, PALETTE_AUTO, FISHGROUP_POND
;	map PlayersHouse2F, TILESET_PLAYERS_ROOM, INDOOR, LANDMARK_SALTBREEZE_TOWN, MUSIC_ANVILLE_TOWN, FALSE, PALETTE_DAY, FISHGROUP_SHORE
;	map SunglowTrail, TILESET_NEOST_OUTDOORS_1, ROUTE, LANDMARK_SUNGLOW_TRAIL, MUSIC_ROUTE_119, FALSE, PALETTE_AUTO, FISHGROUP_POND
;	map SunglowCape, TILESET_NEOST_OUTDOORS_1, ROUTE, LANDMARK_SUNGLOW_CAPE, MUSIC_ROUTE_47, FALSE, PALETTE_AUTO, FISHGROUP_POND
	map SaltbreezeTown, TILESET_NEOST_OUTDOORS_1, TOWN, LANDMARK_SALTBREEZE_TOWN, MUSIC_NEW_BARK_TOWN, FALSE, PALETTE_AUTO, FISHGROUP_POND
	map MyHouse1F, TILESET_Z_HOUSE, INDOOR, LANDMARK_SALTBREEZE_TOWN, MUSIC_NEW_BARK_TOWN, FALSE, PALETTE_AUTO, FISHGROUP_POND
	map PlayersHouse2F, TILESET_PLAYERS_ROOM, INDOOR, LANDMARK_SALTBREEZE_TOWN, MUSIC_NEW_BARK_TOWN, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SunglowTrail, TILESET_NEOST_OUTDOORS_1, ROUTE, LANDMARK_SUNGLOW_TRAIL, MUSIC_NEW_BARK_TOWN, FALSE, PALETTE_AUTO, FISHGROUP_POND
	map SunglowCape, TILESET_NEOST_OUTDOORS_1, ROUTE, LANDMARK_SUNGLOW_CAPE, MUSIC_NEW_BARK_TOWN, FALSE, PALETTE_AUTO, FISHGROUP_POND
	map SunglowHarbor, TILESET_NEOST_OUTDOORS_1, ROUTE, LANDMARK_SUNGLOW_HARBOR, MUSIC_NEW_BARK_TOWN, FALSE, PALETTE_AUTO, FISHGROUP_POND
