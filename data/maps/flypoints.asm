...
; Johto
	...
	db LANDMARK_SALTBREEZE_TOWN,  SPAWN_SALTBREEZE
	db LANDMARK_SUNGLOW_TRAIL,    SPAWN_SUNGLOW_TRAIL
	db LANDMARK_SUNGLOW_CAPE,     SPAWN_SUNGLOW_CAPE
	db LANDMARK_SUNGLOW_HARBOR,   SPAWN_SUNGLOW_HARBOR
	db LANDMARK_SUNGLOW_BEACH,    SPAWN_SUNGLOW_BEACH
	db LANDMARK_SUNGLOW_COVE,     SPAWN_SUNGLOW_COVE
