...
; BattleTowerMons group 2
	...
	db BLISSEY
	db BRIGHTPOWDER
	db PSYCHIC_M, DRAIN_PUNCH, SOFTBOILED, COUNTER
	dw 0 ; OT ID
	dt 8000 ; Exp
	; Stat exp
	bigdw 50000
...
; BattleTowerMons group 4
	...
	db EXEGGUTOR
	db BRIGHTPOWDER
	db BODY_SLAM, STOMP, PSYCH_UP, CONFUSION
	dw 0 ; OT ID
	dt 64000 ; Exp
	; Stat exp
	bigdw 50000
...
; BattleTowerMons group 6
	...
	db UMBREON
	db GOLD_BERRY
	db MUD_SLAP, MORNING_SUN, PSYCHIC_M, FAINT_ATTACK
	dw 0 ; OT ID
	dt 216000 ; Exp
	; Stat exp
	bigdw 50000
...
; BattleTowerMons group 7
	...
	db UMBREON
	db GOLD_BERRY
	db FAINT_ATTACK, MORNING_SUN, PSYCH_UP, TOXIC
	dw 0 ; OT ID
	dt 343000 ; Exp
	; Stat exp
	bigdw 54000
	...
	db UMBREON
	db GOLD_BERRY
	db MORNING_SUN, FAINT_ATTACK, PSYCHIC_M, SHADOW_BALL
	dw 0 ; OT ID
	dt 343000 ; Exp
	; Stat exp
	bigdw 50000
...
; BattleTowerMons group 9
	...
	db UMBREON
	db KINGS_ROCK
	db FAINT_ATTACK, MUD_SLAP, MORNING_SUN, CONFUSE_RAY
	dw 0 ; OT ID
	dt 729000 ; Exp
	; Stat exp
	bigdw 60000
	...
	db MACHAMP
	db QUICK_CLAW
	db ROCK_SMASH, VITAL_THROW, FIRE_BLAST, EARTHQUAKE
	dw 0 ; OT ID
	dt 729000 ; Exp
	; Stat exp
	bigdw 55000
...
; BattleTowerMons group 10
	...
	db MACHAMP
	db QUICK_CLAW
	db ROCK_SMASH, EARTHQUAKE, HYPER_BEAM, VITAL_THROW
	dw 0 ; OT ID
	dt 1000000 ; Exp
	; Stat exp
	bigdw 60000
