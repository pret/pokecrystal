...
; entries correspond to BATTLEANIMFRAMESET_* constants
	...
	dw .Frameset_UnusedMegaphone    ; BATTLEANIMFRAMESET_UNUSED_MEGAPHONE
	...
	dw .Frameset_Imp1               ; BATTLEANIMFRAMESET_IMP_1
	dw .Frameset_Imp2               ; BATTLEANIMFRAMESET_IMP_2
