...
FacingStepDown3: ; walking down 2
	...
	db  0,  8, $20, $80
	db  0,  0, $20, $81
	db  8,  8, RELATIVE_ATTRIBUTES | $20, $82
	db  8,  0, RELATIVE_ATTRIBUTES | $20, $83
...
FacingStepUp3: ; walking up 2
	...
	db  0,  8, $20, $84
	db  0,  0, $20, $85
	db  8,  8, RELATIVE_ATTRIBUTES | $20, $86
	db  8,  0, RELATIVE_ATTRIBUTES | $20, $87
...
FacingStepRight2: ; standing right
	...
	db  0,  8, $20, $08
	db  0,  0, $20, $09
	db  8,  8, RELATIVE_ATTRIBUTES | $20, $0a
	db  8,  0, RELATIVE_ATTRIBUTES | $20, $0b
...
FacingStepRight3: ; walking right
	...
	db  0,  8, $20, $88
	db  0,  0, $20, $89
	db  8,  8, RELATIVE_ATTRIBUTES | $20, $8a
	db  8,  0, RELATIVE_ATTRIBUTES | $20, $8b
...
FacingGrass1:
	db 2 ; #
	db  8,  0, ABSOLUTE_TILE_ID, $fe
	db  8,  8, ABSOLUTE_TILE_ID | $20, $fe

FacingGrass2:
	db 2 ; #
	db  9, -1, ABSOLUTE_TILE_ID, $fe
	db  9,  9, ABSOLUTE_TILE_ID | $20, $fe
