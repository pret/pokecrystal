...
FacingStepDown3: ; walking down 2
	db 4 ; #
	db  0,  8, OAMF_XFLIP, $80
	db  0,  0, OAMF_XFLIP, $81
	db  8,  8, RELATIVE_ATTRIBUTES | OAMF_XFLIP, $82
	db  8,  0, RELATIVE_ATTRIBUTES | OAMF_XFLIP, $83
...
FacingStepUp3: ; walking up 2
	db 4 ; #
	db  0,  8, OAMF_XFLIP, $84
	db  0,  0, OAMF_XFLIP, $85
	db  8,  8, RELATIVE_ATTRIBUTES | OAMF_XFLIP, $86
	db  8,  0, RELATIVE_ATTRIBUTES | OAMF_XFLIP, $87
...
FacingStepRight2: ; standing right
	db 4 ; #
	db  0,  8, OAMF_XFLIP, $08
	db  0,  0, OAMF_XFLIP, $09
	db  8,  8, RELATIVE_ATTRIBUTES | OAMF_XFLIP, $0a
	db  8,  0, RELATIVE_ATTRIBUTES | OAMF_XFLIP, $0b
...
FacingStepRight3: ; walking right
	db 4 ; #
	db  0,  8, OAMF_XFLIP, $88
	db  0,  0, OAMF_XFLIP, $89
	db  8,  8, RELATIVE_ATTRIBUTES | OAMF_XFLIP, $8a
	db  8,  0, RELATIVE_ATTRIBUTES | OAMF_XFLIP, $8b
...
FacingFishLeft: ; fishing left
	...
	db  8,  0, RELATIVE_ATTRIBUTES, $0a
	db  8,  8, RELATIVE_ATTRIBUTES, $0b
	db  5, -8, ABSOLUTE_TILE_ID | OAMF_XFLIP, $fd
...
FacingShadow: ; shadow
	...
	db  0,  8, ABSOLUTE_TILE_ID | OAMF_XFLIP, $fc
...
FacingBigDollSymmetric: ; big snorlax or lapras doll
	...
	db 24,  0, 0, $06
	db 24,  8, 0, $07
	db  0, 24, OAMF_XFLIP, $00
	db  0, 16, OAMF_XFLIP, $01
	db  8, 24, OAMF_XFLIP, $02
	db  8, 16, OAMF_XFLIP, $03
	db 16, 24, OAMF_XFLIP, $04
	db 16, 16, OAMF_XFLIP, $05
	db 24, 24, OAMF_XFLIP, $06
	db 24, 16, OAMF_XFLIP, $07
...
FacingWeirdTree3:
	db 4 ; #
	db  0,  8, OAMF_XFLIP, $04
	db  0,  0, OAMF_XFLIP, $05
	db  8,  8, OAMF_XFLIP, $06
	db  8,  0, OAMF_XFLIP, $07
...
FacingGrass1:
	db 2 ; #
	db  8,  0, ABSOLUTE_TILE_ID, $fe
	db  8,  8, ABSOLUTE_TILE_ID | OAMF_XFLIP, $fe

FacingGrass2:
	db 2 ; #
	db  9, -1, ABSOLUTE_TILE_ID, $fe
	db  9,  9, ABSOLUTE_TILE_ID | OAMF_XFLIP, $fe
