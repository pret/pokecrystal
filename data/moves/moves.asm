...
; entries correspond to move ids (see constants/move_constants.asm)
	...
	move MEGA_PUNCH,   EFFECT_NORMAL_HIT,         80, NORMAL,        PHYSICAL,  85, 20,   0 ; to be removed
	...
	move GUILLOTINE,   EFFECT_OHKO,                0, NORMAL,        PHYSICAL,  30,  5,   0 ; to be removed
	...
	move MEGA_KICK,    EFFECT_NORMAL_HIT,        120, NORMAL,        PHYSICAL,  75,  5,   0 ; to be removed
	move JUMP_KICK,    EFFECT_JUMP_KICK,          70, FIGHTING,      PHYSICAL,  95, 25,   0 ; to be removed
	...
	move HORN_ATTACK,  EFFECT_NORMAL_HIT,         65, ROCK,          PHYSICAL, 100, 25,   0
	move FURY_ATTACK,  EFFECT_MULTI_HIT,          15, NORMAL,        PHYSICAL, 100, 20,   0
	move HORN_DRILL,   EFFECT_OHKO,                1, NORMAL,        PHYSICAL,  30,  5,   0 ; to be removed
	move TACKLE,       EFFECT_NORMAL_HIT,         35, NORMAL,        PHYSICAL, 100, 35,   0
	move BODY_SLAM,    EFFECT_PARALYZE_HIT,       85, NORMAL,        PHYSICAL, 100, 15,  30
	move WRAP,         EFFECT_TRAP_TARGET,        15, NORMAL,        PHYSICAL,  95, 20,   0
	move TAKE_DOWN,    EFFECT_RECOIL_HIT,         90, NORMAL,        PHYSICAL,  85, 20,   0 ; to be removed
	...
	move ROAR,         EFFECT_FORCE_SWITCH,        0, NORMAL,        STATUS,   100, 20,   0 ; to be removed
	...
	move ACID,         EFFECT_DEFENSE_DOWN_HIT,   40, POISON,        SPECIAL,  100, 30,  25
	...
	move SUBMISSION,   EFFECT_RECOIL_HIT,        100, FIGHTING,      PHYSICAL, 100, 25,   0 
	...
	move FIRE_SPIN,    EFFECT_TRAP_TARGET,        15, FIRE,          SPECIAL,   95, 15,   0
	...
	move EARTHQUAKE,   EFFECT_EARTHQUAKE,         90, GROUND,        PHYSICAL, 100, 10,   0
	move FISSURE,      EFFECT_OHKO,                1, GROUND,        PHYSICAL,  30,  5,   0 ; to be removed
	...
	move WITHDRAW,     EFFECT_DEFENSE_UP_2,        0, WATER,         STATUS,   100, 40,   0
	...
	move LICK,         EFFECT_PARALYZE_HIT,       40, GHOST,         PHYSICAL, 100, 30,  10
	move SMOG,         EFFECT_POISON_HIT,         20, POISON,        SPECIAL,  100, 20,  40
	...
	move KINESIS,      EFFECT_ACCURACY_DOWN_HIT,  50, PSYCHIC_TYPE,  STATUS,    80, 15,   0
	...
	move POISON_GAS,   EFFECT_POISON,              0, POISON,        STATUS,    55, 40,   0 ; to be removed
	move BARRAGE,      EFFECT_MULTI_HIT,          15, NORMAL,        PHYSICAL,  85, 20,   0 ; to be removed
	...
	move SNORE,        EFFECT_SNORE,              50, NORMAL,        PHYSICAL,  100, 15,  30
	...
	move OCTAZOOKA,    EFFECT_ACCURACY_DOWN_HIT,  75, WATER,         SPECIAL,   95, 10,  50
	...
	move GIGA_DRAIN,   EFFECT_LEECH_HIT,          70, GRASS,         SPECIAL,  100,  5,   0
	...
	move SPARK,        EFFECT_PARALYZE_HIT,       70, ELECTRIC,      PHYSICAL, 100, 20,  30
	...
	move PRESENT,      EFFECT_PRESENT,             1, NORMAL,        PHYSICAL, 100, 15,   0
	...
	move CROSS_CHOP,   EFFECT_NORMAL_HIT,        100, FIGHTING,      PHYSICAL,  90,  5,   0
	...
	move PSYCH_UP,     EFFECT_PSYCH_UP,            0, NORMAL,        STATUS,   100, 10,   0 ; to be removed
