...
KadabraEvosAttacks:
	db EVOLVE_MOVE, PSYCHIC_M, ALAKAZAM
	db 0 ; no more evolutions
	db 1, TELEPORT
	db 1, KINESIS
	db 1, CONFUSION
...
MachokeEvosAttacks:
	db EVOLVE_MOVE, VITAL_THROW, MACHAMP
	db 0 ; no more evolutions
	db 1, LOW_KICK
	db 1, LEER
	db 1, FOCUS_ENERGY
...
HaunterEvosAttacks:
	db EVOLVE_MOVE, SHADOW_BALL, GENGAR
	db 0 ; no more evolutions
	db 1, HYPNOSIS
	db 1, LICK
	db 1, SPITE
...
SeadraEvosAttacks:
	db EVOLVE_MOVE, DRAGONBREATH, KINGDRA
	db 0 ; no more evolutions
	db 1, BUBBLE
	db 1, SMOKESCREEN
	db 1, LEER
...
BayleefEvosAttacks:
	db EVOLVE_MOVE, FLOWER_BLOOM, MEGANIUM
	db 0 ; no more evolutions
	db 1, TACKLE
	db 1, GROWL
	db 1, RAZOR_LEAF
