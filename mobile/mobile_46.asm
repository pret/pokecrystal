...
MenuHeader_119cf7:
	...
	menu_coords 12, 7, SCRN_X_B - 1, TEXTBOX_Y - 1
	dw NULL
	db 0 ; default option

MenuData_119cff: ; unreferenced
	db MENU_BACKUP_TILES ; flags
	menu_coords 15, 7, SCRN_X_B - 1, TEXTBOX_Y - 1
	dw NULL
	db 0 ; default option
...
MenuHeader_11a2d6: ; unreferenced
	db MENU_BACKUP_TILES ; flags
	menu_coords 14, 6, SCRN_X_B - 1, 10
	dw NULL
	db 0 ; default option
...
MenuHeader_11ae38:
	db MENU_BACKUP_TILES ; flags
	menu_coords 10, 10, 17, SCRN_Y_B - 1
	dw NULL
	db 0 ; default option
...
MenuHeader_11afe8:
	db MENU_BACKUP_TILES ; flags
	menu_coords 9, 12, SCRN_X_B - 1, SCRN_Y_B - 1
	dw NULL
	db 0 ; default option
