...
DEF THIRD_HEIGHT EQU SCRN_Y_B / 3

; bottom
	ld de, 2 * THIRD_HEIGHT * SCRN_X_B
	add hl, de
	ld sp, hl
	...
	ld de, 2 * THIRD_HEIGHT * SCRN_VX_B
	add hl, de
