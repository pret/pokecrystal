...
; tilemap backup?
wPrinterTilemapBuffer:: ds SCRN_Y_B * SCRN_X_B
wPrinterStatus:: db
	ds 1
...
w3_dc00:: ds SCRN_X_B * SCRN_Y_B
UNION
w3_dd68:: ds SCRN_X_B * SCRN_Y_B
...
UNION
wScratchTilemap:: ds SCRN_VX_B * SCRN_VY_B
wScratchAttrmap:: ds SCRN_VX_B * SCRN_VY_B
