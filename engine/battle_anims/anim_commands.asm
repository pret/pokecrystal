...
PlaceWindowOverBattleTextbox: ; unreferenced
	...
	ld a, LOW(vBGMap0 + 20 * SCRN_VX_B)
	ldh [hBGMapAddress], a
	ld a, HIGH(vBGMap0 + 20 * SCRN_VX_B)
	ldh [hBGMapAddress + 1], a
	call WaitBGMap2
	ld a, (SCRN_Y_B - TEXTBOX_HEIGHT) * TILE_X
	ldh [hWY], a
...
.loop
	ld a, [hl]
	and ~(OAMF_PALMASK | OAMF_BANK1) ; zeros out the palette bits
...
.loop
	...
	cp (vTiles1 - vTiles0) / TILE_B - BATTLEANIM_BASE_TILE
