...
LoadEonMailGFX:
	...
	ld c, 1 * TILE_1BPP_B
	call LoadMailGFX_Color2
	ld de, SurfMailBorderGFX + 6 * TILE_1BPP_B
	ld c, 1 * TILE_1BPP_B
	call LoadMailGFX_Color2
	ld de, MailEeveeGFX
	ld c, 6 * TILE_1BPP_B
...
LoadMorphMailGFX:
	...
	ld de, MorphMailBorderCornerGFX + 3 * TILE_1BPP_B
	ld c, 1 * TILE_1BPP_B
	call LoadMailGFX_Color2
...
LoadBlueSkyMailGFX:
	...
	ld c, 6 * TILE_1BPP_B
	call LoadMailGFX_Color1
	ld de, FlowerMailBorderGFX + 6 * TILE_1BPP_B
	ld c, 1 * TILE_1BPP_B
	call LoadMailGFX_Color1
	ld de, MailCloudGFX
	ld c, 1 * TILE_1BPP_B
	call LoadMailGFX_Color1
	ld de, MailCloudGFX + 2 * TILE_1BPP_B
	ld c, 2 * TILE_1BPP_B
	call LoadMailGFX_Color1
	ld de, MailCloudGFX + 5 * TILE_1BPP_B
	ld c, 1 * TILE_1BPP_B
	call LoadMailGFX_Color1
...
LoadMirageMailGFX:
	...
	ld c, 18 * TILE_1BPP_B
	call LoadMailGFX_Color2
	ld de, LiteBlueMailBorderGFX + 1 * TILE_1BPP_B
	ld c, 1 * TILE_1BPP_B
	call LoadMailGFX_Color1
	ld de, LiteBlueMailBorderGFX + 6 * TILE_1BPP_B
	ld c, 1 * TILE_1BPP_B
	call LoadMailGFX_Color1
