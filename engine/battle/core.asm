...
.no_flee_item
	...
	ld a, [hli]
	ldh [hStringCmpString2 + 0], a
	ld a, [hl]
	ldh [hStringCmpString2 + 1], a
	ld a, [de]
	inc de
	ldh [hStringCmpString1 + 0], a
	ld a, [de]
	ldh [hStringCmpString1 + 1], a
	call Call_LoadTempTileMapToTileMap
	...
	ldh a, [hProduct + 3]
	ldh [hDividend + 1], a
	ldh a, [hStringCmpString1 + 0]
	ld b, a
	ldh a, [hStringCmpString1 + 1]
	srl b
	rr a
	srl b
	rr a
