...
.PC_ElmsLab_OAM:
	dbsprite   4,   4, 2, 0, $7c, PAL_OW_TREE | OAMF_PAL1
	dbsprite   4,   4, 6, 0, $7c, PAL_OW_TREE | OAMF_PAL1
	dbsprite   4,   4, 0, 6, $7d, PAL_OW_TREE | OAMF_PAL1
	dbsprite   5,   4, 0, 6, $7d, PAL_OW_TREE | OAMF_PAL1 | OAMF_XFLIP
	dbsprite   4,   5, 0, 3, $7d, PAL_OW_TREE | OAMF_PAL1
	dbsprite   5,   5, 0, 3, $7d, PAL_OW_TREE | OAMF_PAL1 | OAMF_XFLIP
	dbsprite   4,   6, 0, 0, $7d, PAL_OW_TREE | OAMF_PAL1
	dbsprite   5,   6, 0, 0, $7d, PAL_OW_TREE | OAMF_PAL1 | OAMF_XFLIP

.HealMachineGFX:
INCBIN "gfx/overworld/heal_machine.2bpp"

.HOF_OAM:
	dbsprite  10,   7, 1, 4, $7d, PAL_OW_TREE | OAMF_PAL1
	dbsprite  10,   7, 6, 4, $7d, PAL_OW_TREE | OAMF_PAL1
	dbsprite   9,   7, 5, 3, $7d, PAL_OW_TREE | OAMF_PAL1
	dbsprite  11,   7, 2, 3, $7d, PAL_OW_TREE | OAMF_PAL1
	dbsprite   9,   7, 1, 1, $7d, PAL_OW_TREE | OAMF_PAL1
	dbsprite  11,   7, 5, 1, $7d, PAL_OW_TREE | OAMF_PAL1
