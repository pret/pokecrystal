...
; Johto story events
	const EVENT_UNUSED_GOT_A_POKEMON_FROM_ELM
	...
	const EVENT_UNUSED_HERDED_FARFETCHD
...
; More Crystal-exclusive events in Johto
	const EVENT_UNUSED_LISTENED_TO_INITIAL_RADIO 
	...
	const EVENT_UNUSED_WELCOMED_TO_POKECOM_CENTER
...
; Johto people
	...
	const EVENT_UNUSED_RIVAL_CHERRYGROVE_CITY
	const EVENT_UNUSED_RIVAL_AZALEA_TOWN
	...
	const EVENT_UNUSED_CHARCOAL_KILN_FARFETCH_D
	const EVENT_UNUSED_CHARCOAL_KILN_APPRENTICE
	const EVENT_UNUSED_CHARCOAL_KILN_BOSS
	...
	const EVENT_UNUSED_COP_IN_ELMS_LAB
	...
	const EVENT_UNUSED_ROUTE_30_BATTLE
	const EVENT_UNUSED_ROUTE_30_YOUNGSTER_JOEY
