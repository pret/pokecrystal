...
; Schoolboy
	...
	const EVENT_BEAT_SCHOOLBOY_KIPP
...
; Kimono Girl
	const_skip ; unused
	const EVENT_BEAT_KIMONO_GIRL_NAOKO_UNUSED
...
; Crystal-exclusive trainer flags
	...
	const EVENT_BEAT_TWINS_LEA_AND_PIA2
	const EVENT_BEAT_YOUNGSTER_JOEY4
	const EVENT_BEAT_YOUNGSTER_JOEY5
	const EVENT_BEAT_BUG_CATCHER_WADE4
	const EVENT_BEAT_BUG_CATCHER_WADE5
	const EVENT_BEAT_BUG_CATCHER_ARNIE4
	const EVENT_BEAT_BUG_CATCHER_ARNIE5
	const EVENT_BEAT_BUG_CATCHER_WAYNE
	const EVENT_BEAT_BEAUTY_OLIVIA
	const EVENT_BEAT_LASS_DANA4
	const EVENT_BEAT_LASS_DANA5
	const EVENT_BEAT_HIKER_ANTHONY4
	const EVENT_BEAT_HIKER_ANTHONY5
	const EVENT_BEAT_POKEFANF_JAIME
	const EVENT_BEAT_CAMPER_TODD4
	const EVENT_BEAT_CAMPER_TODD5
	const EVENT_BEAT_CAMPER_QUENTIN
	const EVENT_BEAT_FISHER_RALPH4
	const EVENT_BEAT_FISHER_RALPH5
	const EVENT_BEAT_FISHER_TULLY4
	const EVENT_BEAT_SCHOOLBOY_JACK4
	const EVENT_BEAT_SCHOOLBOY_JACK5
	const EVENT_BEAT_SCHOOLBOY_ALAN4
	const EVENT_BEAT_SCHOOLBOY_ALANK4
	const EVENT_BEAT_SCHOOLBOY_CHAD4
	const EVENT_BEAT_SCHOOLBOY_CHAD5
	const EVENT_BEAT_PICNICKER_LIZ4
	const EVENT_BEAT_PICNICKER_LIZ5
	const EVENT_BEAT_PICNICKER_GINA4
	const EVENT_BEAT_PICNICKER_GINA5
	const EVENT_BEAT_PICNICKER_TIFFANY4
	const EVENT_BEAT_SAILOR_HUEY4
	const EVENT_BEAT_JUGGLER_IRWIN4
	const EVENT_BEAT_POKEMANIAC_BRENT4
