...
; rLCDC::
DEF LCDC_DEFAULT EQU LCDCF_ON | LCDCF_WIN9C00 | LCDCF_WINON | LCDCF_BLK21 | LCDCF_BG9800 | LCDCF_OBJ8 | LCDCF_OBJON | LCDCF_BGOFF | LCDCF_PRION

; rIE::
DEF IE_DEFAULT EQU IEF_SERIAL | IEF_TIMER | IEF_STAT | IEF_VBLANK
