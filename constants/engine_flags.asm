...
; wVisitedSpawns
	...
	const ENGINE_FLYPOINT_SALTBREEZE
	const ENGINE_FLYPOINT_SUNGLOW_TRAIL
	const ENGINE_FLYPOINT_SUNGLOW_CAPE
	const ENGINE_FLYPOINT_SUNGLOW_HARBOR
	const ENGINE_FLYPOINT_SUNGLOW_BEACH
	const ENGINE_FLYPOINT_SUNGLOW_COVE
