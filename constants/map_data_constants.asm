...
; johto
	...
	const SPAWN_SALTBREEZE
	const SPAWN_SUNGLOW_TRAIL
	const SPAWN_SUNGLOW_CAPE
	const SPAWN_SUNGLOW_HARBOR
	const SPAWN_SUNGLOW_BEACH
	const SPAWN_SUNGLOW_COVE
...
DEF JOHTO_FLYPOINT EQU const_value
	...
	const FLY_SALTBREEZE
	const FLY_SUNGLOW_TRAIL
	const FLY_SUNGLOW_CAPE
	const FLY_SUNGLOW_HARBOR
	const FLY_SUNGLOW_BEACH
	const FLY_SUNGLOW_COVE
	const FLY_MT_SILVER
; kanto
