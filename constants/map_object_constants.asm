...
rsset MAPOBJECT_HOUR_2            ; HOUR_2 and TIMEOFDAY are the same byte
DEF MAPOBJECT_TIMEOFDAY        rb ; 7
DEF MAPOBJECT_PAL_OVERRIDE     rb ; 8
rsset MAPOBJECT_PAL_OVERRIDE      ; PAL_OVERRIDE and TYPE share a byte
...
DEF MAPOBJECT_PAL_OVERRIDE_MASK EQU %11110000
