...
DEF KRIS EQU __trainer_class__
	...
	trainerclass KOGA ; 11
	const KOGA1

	trainerclass CHAMPION ; 12
	const LANCE

	trainerclass BROCK ; 13
	const BROCK1

	trainerclass MISTY ; 14
	const MISTY1

	trainerclass LT_SURGE ; 15
	const LT_SURGE1

	trainerclass SCIENTIST ; 16
	const ROSS
	const MITCH
	const JED
	const MARC
	...
	trainerclass ERIKA ; 17
	const ERIKA1

	trainerclass YOUNGSTER ; 18
	const MIKEY
	const ALBERT
	const GORDON
	const SAMUEL
	...
	trainerclass JANINE ; 1c
	const JANINE1

	trainerclass COOLTRAINERM ; 1d
	const NICK
	const AARON
	const PAUL
	const CODY
	...
	trainerclass SABRINA ; 25
	const SABRINA1

	trainerclass BUG_CATCHER ; 26
	const DON
	const ROB
	const ED
	const WADE1
	...
	trainerclass BLUE ; 42
	const BLUE1

	trainerclass OFFICER ; 43
	const KEITH
	const DIRK

	trainerclass GRUNTF ; 44
	const GRUNTF_1
	const GRUNTF_2
	const GRUNTF_3
	const GRUNTF_4
