...
; wBTShopFlags::
	const_def
	const ENGINE_SHOP_INITIALIZED_F ;0
	const ENGINE_SHOP_BOUGHT1_F	  ;1
	const ENGINE_SHOP_BOUGHT2_F	  ;2
	const ENGINE_SHOP_BOUGHT3_F	  ;3
	const ENGINE_SHOP_BOUGHT4_F	  ;4
	const ENGINE_SHOP_BOUGHT5_F	  ;5
	const ENGINE_SHOP_BOUGHT6_F	  ;6
