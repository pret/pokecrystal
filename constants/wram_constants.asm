...
; wDailyFlags3::
	const DAILYFLAGS3_BUGSY_REMATCH_FIGHT_F			; 0
	const DAILYFLAGS3_FALKNER_REMATCH_FIGHT_F			; 1
	const DAILYFLAGS3_WHITNEY_REMATCH_FIGHT_F			; 2
	const DAILYFLAGS3_MORTY_REMATCH_FIGHT_F			; 3
	const DAILYFLAGS3_CHUCK_REMATCH_FIGHT_F			; 4
	const DAILYFLAGS3_JASMINE_REMATCH_FIGHT_F			; 5
	const DAILYFLAGS3_PRYCE_REMATCH_FIGHT_F			; 6
	const DAILYFLAGS3_CLAIR_REMATCH_FIGHT_F			; 7

; wDailyFlags4::
	const DAILYFLAGS4_BROCK_REMATCH_FIGHT_F			; 0
	const DAILYFLAGS4_MISTY_REMATCH_FIGHT_F			; 1
	const DAILYFLAGS4_LTSURGE_REMATCH_FIGHT_F			; 2
	const DAILYFLAGS4_ERIKA_REMATCH_FIGHT_F			; 3
	const DAILYFLAGS4_JANINE_REMATCH_FIGHT_F			; 4
	const DAILYFLAGS4_SABRINA_REMATCH_FIGHT_F			; 5
	const DAILYFLAGS4_BLAINE_REMATCH_FIGHT_F			; 6
	const DAILYFLAGS4_BLUE_REMATCH_FIGHT_F			; 7
