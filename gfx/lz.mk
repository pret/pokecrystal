...
$(BUILDDIR)/gfx/intro/suicune_close.2bpp.lz: LZFLAGS += --method 2 --align 4
$(BUILDDIR)/gfx/intro/unown_back.2bpp.lz: LZFLAGS += --method 2 --align 4

$(BUILDDIR)/gfx/mobile/mobile_trade.%.lz: LZFLAGS += --align 4
$(BUILDDIR)/gfx/mobile/mobile_trade_sprites.2bpp.lz: LZFLAGS += --align 4

$(BUILDDIR)/gfx/new_game/shrink1.2bpp.lz: LZFLAGS += --align 4
$(BUILDDIR)/gfx/new_game/shrink2.2bpp.lz: LZFLAGS += --align 4

$(BUILDDIR)/gfx/pc/pc.2bpp.lz: LZFLAGS = --compressor null --method 1 --align 1
...
$(BUILDDIR)/gfx/pokemon/corsola/front.animated.2bpp.lz: LZFLAGS += --method 4
$(BUILDDIR)/gfx/pokemon/hitmontop/back.2bpp.lz: LZFLAGS += --method 4
$(BUILDDIR)/gfx/pokemon/nidoran_f/front.animated.2bpp.lz: LZFLAGS += --method 4
$(BUILDDIR)/gfx/pokemon/primeape/front.animated.2bpp.lz: LZFLAGS += --method 4
$(BUILDDIR)/gfx/pokemon/scyther/front.animated.2bpp.lz: LZFLAGS += --method 4
$(BUILDDIR)/gfx/pokemon/unown_g/front.animated.2bpp.lz: LZFLAGS += --method 4
$(BUILDDIR)/gfx/pokemon/voltorb/front.animated.2bpp.lz: LZFLAGS += --method 4

$(BUILDDIR)/gfx/sgb/gbc_only.2bpp.lz: LZFLAGS = --compressor null --method 1 --align 1
...
$(BUILDDIR)/gfx/splash/ditto.2bpp.lz: LZFLAGS += --method 2 --align 4

$(BUILDDIR)/gfx/tilesets/%.lz: LZFLAGS += --align 4
$(BUILDDIR)/gfx/tilesets/aerodactyl_word_room.2bpp.lz: LZFLAGS = --compressor null --method 1 --align 1
$(BUILDDIR)/gfx/tilesets/battle_tower_outside.2bpp.lz: LZFLAGS = --compressor null --method 1 --align 1
$(BUILDDIR)/gfx/tilesets/beta_word_room.2bpp.lz: LZFLAGS = --compressor null --method 1 --align 1
$(BUILDDIR)/gfx/tilesets/ho_oh_word_room.2bpp.lz: LZFLAGS = --compressor null --method 1 --align 1
...
$(BUILDDIR)/gfx/tilesets/kabuto_word_room.2bpp.lz: LZFLAGS = --compressor null --method 1 --align 1
...
$(BUILDDIR)/gfx/tilesets/omanyte_word_room.2bpp.lz: LZFLAGS = --compressor null --method 1 --align 1
$(BUILDDIR)/gfx/tilesets/players_room.2bpp.lz: LZFLAGS += --method 4 --align 4
$(BUILDDIR)/gfx/tilesets/ruins_of_alph.2bpp.lz: LZFLAGS = --compressor null --method 1 --align 1
$(BUILDDIR)/gfx/tilesets/tower.2bpp.lz: LZFLAGS += --method 2 --align 4

$(BUILDDIR)/gfx/title/crystal.2bpp.lz: LZFLAGS += --align 4
$(BUILDDIR)/gfx/title/logo.2bpp.lz: LZFLAGS = --compressor null --method 1 --align 1
$(BUILDDIR)/gfx/title/suicune.2bpp.lz: LZFLAGS += --align 4
