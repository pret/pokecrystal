...
GoldenrodPokecomCenterPerson7Text: ; unreferenced
	text "The POKéCOM CENTER"
	line "will link with all"

	para "POKéMON CENTERS in"
	line "a wireless net."
