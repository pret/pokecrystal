...
.PersonEvents:
	db 2
	person_event SPRITE_TEACHER, 8, 6, $9, 0, 0, -1, -1, $0, 0, FlowerShopTeacherScript, -1
	person_event SPRITE_LASS, 10, 9, $2, 1, 1, -1, -1, (PAL_OW_BLUE << 4) | $80, 0, FlowerShopFloriaScript, EVENT_FLORIA_AT_FLOWER_SHOP
