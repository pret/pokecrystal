...
.PersonEvents:
	db 2
	person_event SPRITE_RECEPTIONIST, 5, 11, $6, 0, 0, -1, -1, (PAL_OW_GREEN << 4) | $80, 0, ObjectEvent, -1
	person_event SPRITE_CHRIS, 15, 10, $8, 0, 0, -1, -1, (PAL_OW_RED << 4) | $80, 0, ObjectEvent, -1
