...
.PersonEvents:
	db 2
	person_event SPRITE_SUPER_NERD, 6, 13, $7, 0, 0, -1, -1, $0, 0, SuperNerdScript_0x7117a, -1
	person_event SPRITE_YOUNGSTER, 9, 16, $2, 1, 2, -1, -1, (PAL_OW_RED << 4) | $80, 0, YoungsterScript_0x7117d, -1
