...
.PersonEvents:
	db 9
	person_event SPRITE_BOULDER, 12, 21, $19, 0, 0, -1, -1, $0, 0, BurnedTowerB1FBoulder, -1
	person_event SPRITE_RAIKOU, 7, 11, $16, 0, 0, -1, -1, (PAL_OW_BROWN << 4) | $80, 0, ObjectEvent, EVENT_BURNED_TOWER_B1F_BEASTS_1
	person_event SPRITE_ENTEI, 7, 16, $16, 0, 0, -1, -1, (PAL_OW_RED << 4) | $80, 0, ObjectEvent, EVENT_BURNED_TOWER_B1F_BEASTS_1
	person_event SPRITE_SUICUNE, 8, 14, $16, 0, 0, -1, -1, (PAL_OW_BLUE << 4) | $80, 0, ObjectEvent, EVENT_BURNED_TOWER_B1F_BEASTS_1
	person_event SPRITE_RAIKOU, 7, 11, $6, 0, 0, -1, -1, (PAL_OW_SILVER << 4) | $80, 0, ObjectEvent, EVENT_BURNED_TOWER_B1F_BEASTS_2
	person_event SPRITE_ENTEI, 7, 16, $6, 0, 0, -1, -1, (PAL_OW_SILVER << 4) | $80, 0, ObjectEvent, EVENT_BURNED_TOWER_B1F_BEASTS_2
	person_event SPRITE_SUICUNE, 8, 14, $6, 0, 0, -1, -1, (PAL_OW_SILVER << 4) | $80, 0, ObjectEvent, EVENT_BURNED_TOWER_B1F_BEASTS_2
	person_event SPRITE_POKE_BALL, 8, 20, $1, 0, 0, -1, -1, $1, 0, ItemFragment_0x186231, EVENT_BURNED_TOWER_B1F_TM_ENDURE
	person_event SPRITE_SUPER_NERD, 16, 14, $7, 0, 0, -1, -1, (PAL_OW_BLUE << 4) | $80, 0, SuperNerdScript_0x186212, EVENT_EUSINE_IN_BURNED_TOWER
