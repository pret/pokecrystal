...
Route37_MapEvents:
	...
	bg_event  9, 13, BGEVENT_ITEM, Route37HiddenEther
	...
	object_event  5,  6, SPRITE_YOUNGSTER, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_TRAINER, 2, TrainerPsychicGreg, -1
