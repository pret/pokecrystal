...
.PersonEvents:
	db 7
	person_event SPRITE_YOUNGSTER, 14, 14, $9, 0, 0, -1, -1, (PAL_OW_BLUE << 4) | $82, 4, TrainerSchoolboyKipp, -1
	person_event SPRITE_YOUNGSTER, 17, 19, $7, 0, 0, -1, -1, (PAL_OW_BLUE << 4) | $82, 3, TrainerSchoolboyTommy, -1
	person_event SPRITE_YOUNGSTER, 14, 37, $6, 0, 0, -1, -1, (PAL_OW_BLUE << 4) | $82, 3, TrainerSchoolboyJohnny, -1
	person_event SPRITE_YOUNGSTER, 14, 31, $6, 0, 0, -1, -1, (PAL_OW_BLUE << 4) | $82, 3, TrainerSchoolboyBilly, -1
	person_event SPRITE_TEACHER, 16, 34, $7, 0, 0, -1, -1, (PAL_OW_RED << 4) | $82, 4, TrainerTeacherColette, -1
	person_event SPRITE_TEACHER, 14, 24, $a, 0, 0, -1, -1, (PAL_OW_RED << 4) | $82, 3, TrainerTeacherHillary, -1
	person_event SPRITE_POKE_BALL, 9, 16, $1, 0, 0, -1, -1, $1, 0, ItemFragment_0x1aa5e4, EVENT_ROUTE_15_PP_UP
