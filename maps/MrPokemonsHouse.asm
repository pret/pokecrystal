...
.PersonEvents:
	db 2
	person_event SPRITE_GENTLEMAN, 9, 7, $9, 0, 0, -1, -1, $0, 0, GentlemanScript_0x196e97, -1
	person_event SPRITE_OAK, 9, 10, $7, 0, 0, -1, -1, $0, 0, ObjectEvent, EVENT_MR_POKEMONS_HOUSE_OAK
