...
.PersonEvents:
	db 2
	person_event SPRITE_YOUNGSTER, 16, 13, $a, 0, 0, -1, -1, (PAL_OW_BLUE << 4) | $82, 3, TrainerBird_keeperBoris, -1
	person_event SPRITE_YOUNGSTER, 10, 17, $6, 0, 0, -1, -1, (PAL_OW_BLUE << 4) | $82, 3, TrainerBird_keeperBob, -1
