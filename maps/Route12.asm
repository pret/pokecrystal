...
.PersonEvents:
	db 6
	person_event SPRITE_FISHER, 17, 9, $a, 0, 0, -1, -1, (PAL_OW_GREEN << 4) | $82, 1, TrainerFisherMartin, -1
	person_event SPRITE_FISHER, 27, 18, $6, 0, 0, -1, -1, (PAL_OW_GREEN << 4) | $82, 1, TrainerFisherStephen, -1
	person_event SPRITE_FISHER, 42, 14, $8, 0, 0, -1, -1, (PAL_OW_GREEN << 4) | $82, 5, TrainerFisherBarney, -1
	person_event SPRITE_FISHER, 11, 10, $9, 0, 0, -1, -1, (PAL_OW_GREEN << 4) | $82, 3, TrainerFisherKyle, -1
	person_event SPRITE_POKE_BALL, 47, 9, $1, 0, 0, -1, -1, $1, 0, ItemFragment_0x1a700b, EVENT_ROUTE_12_CALCIUM
	person_event SPRITE_POKE_BALL, 55, 9, $1, 0, 0, -1, -1, $1, 0, ItemFragment_0x1a700d, EVENT_ROUTE_12_NUGGET
