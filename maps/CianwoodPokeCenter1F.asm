...
.PersonEvents:
	db 4
	person_event SPRITE_NURSE, 5, 7, $6, 0, 0, -1, -1, $0, 0, NurseScript_0x9dbcf, -1
	person_event SPRITE_LASS, 9, 5, $4, 1, 0, -1, -1, (PAL_OW_GREEN << 4) | $80, 0, LassScript_0x9dbd2, -1
	person_event SPRITE_GYM_GUY, 7, 9, $6, 0, 0, -1, -1, (PAL_OW_RED << 4) | $80, 0, CianwoodGymGuyScript, -1
	person_event SPRITE_SUPER_NERD, 10, 12, $5, 0, 1, -1, -1, (PAL_OW_BLUE << 4) | $80, 0, SuperNerdScript_0x9dbea, -1
