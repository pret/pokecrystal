...
.PersonEvents:
	db 10
	person_event SPRITE_OLIVINE_RIVAL, 10, 36, $a, 0, 0, -1, -1, (PAL_OW_RED << 4) | $82, 3, TrainerSwimmermCharlie, -1
	person_event SPRITE_OLIVINE_RIVAL, 12, 50, $a, 0, 0, -1, -1, (PAL_OW_RED << 4) | $82, 3, TrainerSwimmermGeorge, -1
	person_event SPRITE_OLIVINE_RIVAL, 30, 24, $1e, 0, 0, -1, -1, (PAL_OW_RED << 4) | $82, 3, TrainerSwimmermBerke, -1
	person_event SPRITE_OLIVINE_RIVAL, 34, 36, $1f, 0, 0, -1, -1, (PAL_OW_RED << 4) | $82, 3, TrainerSwimmermKirk, -1
	person_event SPRITE_OLIVINE_RIVAL, 50, 23, $1e, 0, 0, -1, -1, (PAL_OW_RED << 4) | $82, 3, TrainerSwimmermMathew, -1
	person_event SPRITE_SWIMMER_GIRL, 8, 21, $a, 0, 0, -1, -1, (PAL_OW_GREEN << 4) | $82, 3, TrainerSwimmerfKaylee, -1
	person_event SPRITE_SWIMMER_GIRL, 23, 27, $7, 0, 0, -1, -1, (PAL_OW_GREEN << 4) | $82, 3, TrainerSwimmerfSusie, -1
	person_event SPRITE_SWIMMER_GIRL, 38, 31, $8, 0, 0, -1, -1, (PAL_OW_GREEN << 4) | $82, 3, TrainerSwimmerfDenise, -1
	person_event SPRITE_SWIMMER_GIRL, 32, 48, $9, 0, 0, -1, -1, (PAL_OW_GREEN << 4) | $82, 4, TrainerSwimmerfKara, -1
	person_event SPRITE_SWIMMER_GIRL, 54, 13, $a, 0, 0, -1, -1, (PAL_OW_GREEN << 4) | $82, 2, TrainerSwimmerfWendy, -1
