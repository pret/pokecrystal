...
.PersonEvents:
	db 3
	person_event SPRITE_SWIMMER_GIRL, 12, 56, $a, 0, 0, -1, -1, (PAL_OW_GREEN << 4) | $82, 3, TrainerSwimmerfNicole, -1
	person_event SPRITE_SWIMMER_GIRL, 17, 49, $a, 0, 0, -1, -1, (PAL_OW_GREEN << 4) | $82, 3, TrainerSwimmerfLori, -1
	person_event SPRITE_SWIMMER_GUY, 17, 16, $a, 0, 0, -1, -1, (PAL_OW_RED << 4) | $82, 3, TrainerSwimmermCameron, -1
