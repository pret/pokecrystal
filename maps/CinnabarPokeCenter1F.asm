...
.PersonEvents:
	db 3
	person_event SPRITE_NURSE, 5, 7, $6, 0, 0, -1, -1, $0, 0, NurseScript_0x1ab32c, -1
	person_event SPRITE_COOLTRAINER_F, 10, 11, $5, 0, 2, -1, -1, (PAL_OW_RED << 4) | $80, 0, CooltrainerFScript_0x1ab32f, -1
	person_event SPRITE_FISHER, 8, 6, $6, 0, 0, -1, -1, (PAL_OW_GREEN << 4) | $80, 0, FisherScript_0x1ab332, -1
