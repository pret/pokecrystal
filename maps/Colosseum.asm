...
.PersonEvents:
	db 2
	person_event SPRITE_CHRIS, 8, 7, $9, 0, 0, -1, -1, $0, 0, ChrisScript_0x193499, EVENT_GAVE_KURT_APRICORNS
	person_event SPRITE_CHRIS, 8, 10, $8, 0, 0, -1, -1, $0, 0, ChrisScript_0x193499, EVENT_RECEIVED_BALLS_FROM_KURT
