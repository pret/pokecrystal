...
.PersonEvents:
	db 2
	person_event SPRITE_RECEPTIONIST, 9, 9, $6, 0, 0, -1, -1, $0, 0, ReceptionistScript_0x58769, EVENT_RUINS_OF_ALPH_KABUTO_CHAMBER_RECEPTIONIST
	person_event SPRITE_SCIENTIST, 5, 7, $7, 0, 0, -1, -1, (PAL_OW_BLUE << 4) | $80, 0, ScientistScript_0x587a8, -1
