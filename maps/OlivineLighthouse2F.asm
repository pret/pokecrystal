...
.PersonEvents:
	db 2
	person_event SPRITE_SAILOR, 7, 13, $9, 0, 0, -1, -1, (PAL_OW_BLUE << 4) | $82, 3, TrainerSailorHuey1, -1
	person_event SPRITE_GENTLEMAN, 12, 21, $8, 0, 0, -1, -1, (PAL_OW_BLUE << 4) | $82, 3, TrainerGentlemanAlfred, -1
