...
.PersonEvents:
	db 2
	person_event SPRITE_OFFICER, 6, 9, $6, 0, 0, -1, -1, (PAL_OW_RED << 4) | $80, 0, OfficerScript_0x197634, -1
	person_event SPRITE_COOLTRAINER_F, 6, 5, $3, 0, 0, -1, -1, (PAL_OW_BLUE << 4) | $80, 0, CooltrainerFScript_0x197637, -1
