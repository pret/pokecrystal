...
.PersonEvents:
	db 11
	person_event SPRITE_PHARMACIST, 16, 13, $9, 0, 0, -1, -1, (PAL_OW_GREEN << 4) | $82, 2, TrainerBurglarDuncan, EVENT_RADIO_TOWER_ROCKET_TAKEOVER
	person_event SPRITE_PHARMACIST, 12, 8, $8, 0, 0, -1, -1, (PAL_OW_GREEN << 4) | $82, 2, TrainerBurglarEddie, EVENT_RADIO_TOWER_ROCKET_TAKEOVER
	person_event SPRITE_ROCKET, 6, 21, $6, 0, 0, -1, -1, $2, 3, TrainerGruntM13, EVENT_RADIO_TOWER_ROCKET_TAKEOVER
	person_event SPRITE_ROCKET, 6, 15, $6, 0, 0, -1, -1, $2, 3, TrainerGruntM11, EVENT_RADIO_TOWER_ROCKET_TAKEOVER
	person_event SPRITE_ROCKET, 6, 7, $6, 0, 0, -1, -1, $2, 3, TrainerGruntM25, EVENT_RADIO_TOWER_ROCKET_TAKEOVER
	person_event SPRITE_ROCKET_GIRL, 16, 23, $6, 0, 0, -1, -1, (PAL_OW_RED << 4) | $82, 1, TrainerGruntF3, EVENT_RADIO_TOWER_ROCKET_TAKEOVER
	person_event SPRITE_TEACHER, 31, 7, $6, 0, 0, -1, -1, $0, 0, TeacherScript_0x7ca7d, -1
	person_event SPRITE_SUPER_NERD, 31, 23, $6, 0, 0, -1, -1, $0, 0, SuperNerdScript_0x7ca7a, -1
	person_event SPRITE_POKE_BALL, 16, 5, $1, 0, 0, -1, -1, $1, 0, ItemFragment_0x7ce7d, EVENT_UNDERGROUND_PATH_SWITCH_ROOM_ENTRANCES_SMOKE_BALL
	person_event SPRITE_POKE_BALL, 13, 18, $1, 0, 0, -1, -1, $1, 0, ItemFragment_0x7ce7f, EVENT_UNDERGROUND_PATH_SWITCH_ROOM_ENTRANCES_FULL_HEAL
	person_event SPRITE_SILVER, 7, 27, $6, 0, 0, -1, -1, $0, 0, ObjectEvent, EVENT_RIVAL_UNDERGROUND_PATH
