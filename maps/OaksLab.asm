...
.PersonEvents:
	db 4
	person_event SPRITE_OAK, 6, 8, $6, 0, 0, -1, -1, $0, 0, Oak, -1
	person_event SPRITE_SCIENTIST, 12, 5, $5, 0, 1, -1, -1, (PAL_OW_BLUE << 4) | $80, 0, ScientistScript_0x19b40f, -1
	person_event SPRITE_SCIENTIST, 13, 12, $4, 1, 0, -1, -1, (PAL_OW_BLUE << 4) | $80, 0, ScientistScript_0x19b412, -1
	person_event SPRITE_SCIENTIST, 8, 5, $2, 1, 1, -1, -1, (PAL_OW_BLUE << 4) | $80, 0, ScientistScript_0x19b415, -1
