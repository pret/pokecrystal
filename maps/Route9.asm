...
.PersonEvents:
	db 6
	person_event SPRITE_YOUNGSTER, 15, 27, $8, 0, 0, -1, -1, (PAL_OW_GREEN << 4) | $82, 3, TrainerCamperDean, -1
	person_event SPRITE_LASS, 12, 43, $a, 0, 0, -1, -1, (PAL_OW_GREEN << 4) | $82, 3, TrainerPicnickerHeidi, -1
	person_event SPRITE_YOUNGSTER, 8, 15, $a, 0, 0, -1, -1, (PAL_OW_GREEN << 4) | $82, 5, TrainerCamperSid, -1
	person_event SPRITE_LASS, 19, 16, $7, 0, 0, -1, -1, (PAL_OW_GREEN << 4) | $82, 1, TrainerPicnickerEdna, -1
	person_event SPRITE_POKEFAN_M, 7, 32, $9, 0, 0, -1, -1, (PAL_OW_BROWN << 4) | $82, 2, TrainerHikerTim, -1
	person_event SPRITE_POKEFAN_M, 19, 40, $9, 0, 0, -1, -1, (PAL_OW_BROWN << 4) | $82, 4, TrainerHikerSidney, -1
