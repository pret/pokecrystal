...
.PersonEvents:
	db 5
	person_event SPRITE_YOUNGSTER, 18, 26, $a, 0, 0, -1, -1, (PAL_OW_BLUE << 4) | $82, 3, TrainerYoungsterOwen, -1
	person_event SPRITE_YOUNGSTER, 8, 24, $6, 0, 0, -1, -1, (PAL_OW_BLUE << 4) | $82, 3, TrainerYoungsterJason, -1
	person_event SPRITE_YOUNGSTER, 11, 32, $6, 0, 0, -1, -1, (PAL_OW_BLUE << 4) | $82, 1, TrainerPsychicHerman, -1
	person_event SPRITE_YOUNGSTER, 10, 12, $a, 0, 0, -1, -1, (PAL_OW_BLUE << 4) | $82, 3, TrainerPsychicFidel, -1
	person_event SPRITE_FRUIT_TREE, 6, 36, $1, 0, 0, -1, -1, $0, 0, FruitTreeScript_0x68055, -1
