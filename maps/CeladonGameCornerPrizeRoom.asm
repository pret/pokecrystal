...
.PersonEvents:
	db 2
	person_event SPRITE_GENTLEMAN, 6, 4, $6, 0, 0, -1, -1, (PAL_OW_RED << 4) | $80, 0, GentlemanScript_0x726e9, -1
	person_event SPRITE_PHARMACIST, 8, 8, $4, 1, 0, -1, -1, (PAL_OW_GREEN << 4) | $80, 0, PharmacistScript_0x726ec, -1
