...
.PersonEvents:
	db 5
	person_event SPRITE_CLAIR, 7, 9, $6, 0, 0, -1, -1, (PAL_OW_BLUE << 4) | $80, 0, ClairScript_0x194e24, -1
	person_event SPRITE_COOLTRAINER_M, 10, 10, $6, 0, 0, -1, -1, (PAL_OW_RED << 4) | $82, 3, TrainerCooltrainermMike, -1
	person_event SPRITE_COOLTRAINER_M, 18, 5, $6, 0, 0, -1, -1, (PAL_OW_RED << 4) | $82, 3, TrainerCooltrainermPaul, -1
	person_event SPRITE_COOLTRAINER_F, 6, 13, $6, 0, 0, -1, -1, (PAL_OW_RED << 4) | $82, 1, TrainerCooltrainerfLola, -1
	person_event SPRITE_GYM_GUY, 19, 11, $6, 0, 0, -1, -1, (PAL_OW_RED << 4) | $80, 0, BlackthornGymGuyScript, -1
