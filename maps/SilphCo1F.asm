...
.PersonEvents:
	db 2
	person_event SPRITE_RECEPTIONIST, 6, 8, $6, 0, 0, -1, -1, (PAL_OW_BLUE << 4) | $80, 0, ReceptionistScript_0x18abe5, -1
	person_event SPRITE_OFFICER, 5, 17, $6, 0, 0, -1, -1, (PAL_OW_BLUE << 4) | $80, 0, OfficerScript_0x18abe8, -1
