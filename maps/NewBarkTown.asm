...
.PersonEvents:
	db 3
	person_event SPRITE_TEACHER, 12, 10, $3, 0, 1, -1, -1, $0, 0, TeacherScript_0x1a806f, -1
	person_event SPRITE_FISHER, 13, 16, $4, 1, 0, -1, -1, (PAL_OW_GREEN << 4) | $80, 0, FisherScript_0x1a809b, -1
	person_event SPRITE_SILVER, 6, 7, $9, 0, 0, -1, -1, $0, 0, SilverScript_0x1a809e, EVENT_RIVAL_NEW_BARK_TOWN
