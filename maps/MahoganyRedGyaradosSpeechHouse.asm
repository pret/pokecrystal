...
.PersonEvents:
	db 2
	person_event SPRITE_BLACK_BELT, 7, 6, $9, 0, 0, -1, -1, $0, 0, BlackBeltScript_0x19997f, -1
	person_event SPRITE_TEACHER, 9, 10, $4, 1, 0, -1, -1, (PAL_OW_BLUE << 4) | $80, 0, TeacherScript_0x199982, -1
