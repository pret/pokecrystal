...
.PersonEvents:
	db 2
	person_event SPRITE_GRAMPS, 7, 6, $9, 0, 0, -1, -1, $0, 0, GrampsScript_0x62f8f, EVENT_DAYCARE_MAN_IN_DAYCARE
	person_event SPRITE_GRANNY, 7, 9, $8, 0, 0, -1, -1, (PAL_OW_RED << 4) | $80, 0, GrannyScript_0x62fc3, -1
