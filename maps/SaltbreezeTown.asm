...
SaltbreezeTown_MapEvents:
	...
	def_warp_events
	warp_event  25,  47, MY_HOUSE_1F, 1
	...
	def_object_events
;	object_event 28, 47, SPRITE_BULBASAUR, SPRITEMOVEDATA_POKEMON, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, BulbasaurScript, EVENT_GOT_BULBASAUR ; [E-1]
