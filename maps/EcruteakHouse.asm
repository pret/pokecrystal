...
.PersonEvents:
	db 4
	person_event SPRITE_SAGE, 10, 8, $6, 0, 0, -1, -1, $0, 0, SageScript_0x98062, EVENT_RANG_CLEAR_BELL_1
	person_event SPRITE_SAGE, 10, 9, $6, 0, 0, -1, -1, $0, 0, SageScript_0x98062, EVENT_RANG_CLEAR_BELL_2
	person_event SPRITE_SAGE, 13, 10, $2, 1, 1, -1, -1, $0, 0, SageScript_0x980b0, EVENT_ECRUTEAK_HOUSE_WANDERING_SAGE
	person_event SPRITE_GRAMPS, 15, 7, $2, 1, 1, -1, -1, $0, 0, GrampsScript_0x980c4, EVENT_ECRUTEAK_HOUSE_WANDERING_SAGE
