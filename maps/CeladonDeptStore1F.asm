...
.PersonEvents:
	db 3
	person_event SPRITE_RECEPTIONIST, 5, 14, $6, 0, 0, -1, -1, (PAL_OW_RED << 4) | $80, 0, ReceptionistScript_0x709e0, -1
	person_event SPRITE_GENTLEMAN, 8, 15, $2, 1, 1, -1, -1, $0, 0, GentlemanScript_0x709e3, -1
	person_event SPRITE_TEACHER, 7, 9, $5, 0, 1, -1, -1, (PAL_OW_GREEN << 4) | $80, 0, TeacherScript_0x709e6, -1
