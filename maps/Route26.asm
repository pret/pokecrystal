...
.PersonEvents:
	db 8
	person_event SPRITE_COOLTRAINER_M, 28, 18, $8, 0, 0, -1, -1, (PAL_OW_RED << 4) | $82, 2, TrainerCooltrainermJake, -1
	person_event SPRITE_COOLTRAINER_M, 42, 13, $8, 0, 0, -1, -1, (PAL_OW_RED << 4) | $82, 3, TrainerCooltrainermGaven3, -1
	person_event SPRITE_COOLTRAINER_F, 60, 14, $a, 0, 0, -1, -1, (PAL_OW_RED << 4) | $82, 3, TrainerCooltrainerfJoyce, -1
	person_event SPRITE_COOLTRAINER_F, 12, 9, $9, 0, 0, -1, -1, (PAL_OW_RED << 4) | $82, 4, TrainerCooltrainerfBeth1, -1
	person_event SPRITE_YOUNGSTER, 83, 17, $9, 0, 0, -1, -1, (PAL_OW_BLUE << 4) | $82, 2, TrainerPsychicRichard, -1
	person_event SPRITE_FISHER, 96, 14, $6, 0, 0, -1, -1, (PAL_OW_GREEN << 4) | $82, 3, TrainerFisherScott, -1
	person_event SPRITE_FRUIT_TREE, 58, 18, $1, 0, 0, -1, -1, $0, 0, FruitTreeScript_0x1a4ec2, -1
	person_event SPRITE_POKE_BALL, 19, 13, $1, 0, 0, -1, -1, $1, 0, ItemFragment_0x1a4ec4, EVENT_ROUTE_26_MAX_ELIXER
