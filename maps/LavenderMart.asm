...
.PersonEvents:
	db 3
	person_event SPRITE_CLERK, 7, 5, $9, 0, 0, -1, -1, $0, 0, ClerkScript_0x7eb1c, -1
	person_event SPRITE_POKEFAN_M, 10, 10, $5, 0, 2, -1, -1, (PAL_OW_RED << 4) | $80, 0, PokefanMScript_0x7eb23, -1
	person_event SPRITE_ROCKER, 6, 13, $3, 0, 0, -1, -1, $0, 0, RockerScript_0x7eb26, -1
