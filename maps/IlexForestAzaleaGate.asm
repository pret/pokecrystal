...
.PersonEvents:
	db 2
	person_event SPRITE_OFFICER, 6, 9, $6, 0, 0, -1, -1, (PAL_OW_RED << 4) | $80, 0, OfficerScript_0x62c7a, -1
	person_event SPRITE_GRANNY, 7, 5, $6, 0, 0, -1, -1, (PAL_OW_BROWN << 4) | $80, 0, GrannyScript_0x62c7d, -1
