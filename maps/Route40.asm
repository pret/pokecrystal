...
Route40_MapEvents:
	...
	object_event 16,  9, SPRITE_YOUNGSTER, SPRITEMOVEDATA_SPINRANDOM_SLOW, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, Route40YoungsterScript, EVENT_BATTLE_TOWER_OPEN_CIVILIANS
