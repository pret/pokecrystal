...
.PersonEvents:
	db 4
	person_event SPRITE_GRANNY, 9, 5, $3, 0, 0, -1, -1, $0, 0, CeladonMansionManager, -1
	person_event SPRITE_GROWLITHE, 10, 6, $16, 0, 0, -1, -1, $0, 0, CeladonMansion1FMeowth, -1
	person_event SPRITE_CLEFAIRY, 8, 7, $16, 0, 0, -1, -1, $0, 0, CeladonMansion1FClefairy, -1
	person_event SPRITE_GROWLITHE, 8, 8, $16, 0, 2, -1, -1, (PAL_OW_BLUE << 4) | $80, 0, CeladonMansion1FNidoranF, -1
