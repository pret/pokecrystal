...
.PersonEvents:
	db 2
	person_event SPRITE_POKEFAN_M, 6, 7, $6, 0, 0, -1, -1, (PAL_OW_BLUE << 4) | $80, 0, PokefanMScript_0x9ceb4, -1
	person_event SPRITE_POKEFAN_F, 8, 9, $8, 0, 0, -1, -1, (PAL_OW_BROWN << 4) | $80, 0, PokefanFScript_0x9cf0e, -1
