...
.PersonEvents:
	db 2
	person_event SPRITE_LASS, 9, 7, $8, 0, 0, -1, -1, (PAL_OW_GREEN << 4) | $80, 0, LassScript_0x196cb9, -1
	person_event SPRITE_YOUNGSTER, 9, 6, $9, 0, 0, -1, -1, (PAL_OW_RED << 4) | $80, 0, YoungsterScript_0x196cb2, -1
