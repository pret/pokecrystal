...
.PersonEvents:
	db 4
	person_event SPRITE_GRAMPS, 9, 22, $2, 2, 2, -1, -1, $0, 0, GrampsScript_0x1a9a4c, -1
	person_event SPRITE_GRAMPS, 12, 34, $6, 0, 0, -1, -1, (PAL_OW_BLUE << 4) | $80, 0, GrampsScript_0x1a9a61, -1
	person_event SPRITE_FISHER, 27, 10, $6, 0, 0, -1, -1, (PAL_OW_RED << 4) | $80, 0, FisherScript_0x1a9a75, -1
	person_event SPRITE_YOUNGSTER, 25, 21, $2, 3, 3, -1, -1, (PAL_OW_GREEN << 4) | $80, 0, YoungsterScript_0x1a9a90, -1
