...
TrainerYoungsterJoey:
	trainer YOUNGSTER, JOEY0, EVENT_BEAT_YOUNGSTER_JOEY, YoungsterJoey1SeenText, YoungsterJoey1BeatenText, 0, .Script
...
.RequestNumber:
	...
	gettrainername STRING_BUFFER_3, YOUNGSTER, JOEY0
