...
- [Single-player battle engine](#single-player-battle-engine)
  ...
  - [Solar Beam, Flame Wheel, and Moonlight are not in the "Smart" AI's list of Sunny Day-encouraging moves](#solar-beam-flame-wheel-and-moonlight-are-not-in-the-smart-ais-list-of-sunny-day-encouraging-moves))
...
### Solar Beam, Flame Wheel, and Moonlight are not in the "Smart" AI's list of Sunny Day-encouraging moves
